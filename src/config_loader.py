...
def load_config(config_path: str = "config.ini") -> dict:
    ...
    return {
        ...
        "artifact_repository": {
            "enabled": get_bool("artifact_repository", "enabled", False),
            "maven_mirror_url": get("artifact_repository", "maven_mirror_url", ""),
            "maven_mirror_id": get("artifact_repository", "maven_mirror_id", "enterprise"),
            "maven_release_url": get("artifact_repository", "maven_release_url", ""),
            "maven_snapshot_url": get("artifact_repository", "maven_snapshot_url", ""),
            "maven_username": get("artifact_repository", "maven_username", "") or os.environ.get("ARTIFACT_REPO_MAVEN_USERNAME", ""),
            "maven_password": get("artifact_repository", "maven_password", "") or os.environ.get("ARTIFACT_REPO_MAVEN_PASSWORD", ""),
            "npm_registry_url": get("artifact_repository", "npm_registry_url", ""),
            "npm_auth_token": get("artifact_repository", "npm_auth_token", "") or os.environ.get("ARTIFACT_REPO_NPM_AUTH_TOKEN", ""),
            "gradle_plugin_url": get("artifact_repository", "gradle_plugin_url", ""),
            "verify_ssl": get_bool("artifact_repository", "verify_ssl", True),
            "ca_cert_path": get("artifact_repository", "ca_cert_path", ""),
        },
        "splunk": {
